...
$ARGV[0]="c:/Users/sstuff/Desktop/fimo-gene-&-position-sorted.gff"; #Input
$ARGV[1]="c:/Users/sstuff/Desktop/positive.gff"; #Output, data from the positive strand
$ARGV[2]="c:/Users/sstuff/Desktop/negative.gff"; #Output, data from the negative strand
print "Please, introduce overlap value: ";
$ARGV[3]=<STDIN>; #we need to set the overlap value. If two motifs overlap and 
                  #surpass the $OL (overlap value) then they will be compared.
